...
add_action( 'init', 'create_personal_tax', 0 );
function create_personal_tax() {
    $args = array(
        'label' => _x( 'Категории сотрудников', 'taxonomy general name' ), // Название таксономии во множественном числе для перевода. По умолчанию: значение аргумента 'name' массива 'labels'.
        // Массив значений таксономии для управления в админ-панели:
        'labels' => array(
            'name' => _x( 'Категории сотрудников', 'taxonomy general name' ), // Общее название таксономии, используется во множественном числе. Соответствует значению label. По умолчанию: _x( 'Метки', 'taxonomy general name' ) или _x( 'Рубрики', 'taxonomy general name' ).
            'singular_name' => _x( 'Категория сотрудников', 'taxonomy singular name' ), // Название таксономии в единственном числе. По умолчанию: _x( 'Метка', 'taxonomy singular name' ) или _x( 'Рубрика', 'taxonomy singular name' ).
            'menu_name' => __( 'Категории сотрудников' ), // Название таксономии в пункте меню. Если не задается, то используется значение label. По умолчанию: 'Метки' или 'Рубрики'.
            'all_items' => __( 'Все категории сотрудников' ), // Текст всех таксономий. По умолчанию: __( 'Все метки' ) или __( 'Все рубрики' ).
            'edit_item' => __( 'Изменить категорию сотрудников' ), // Текст изменения таксономии на странице ее редактирования. По умолчанию: __( 'Изменить метку' ) или __( 'Изменить рубрику' ).
            'view_item' => __( 'Просмотреть категорию сотрудников' ), // Текст просмотра таксономии, который появляется в навигационном баре админ-панели на странице редактирования данной таксономии. По умолчанию: __( 'Просмотреть метку' ) или __( 'Просмотреть рубрику' ).
            'update_item' => __( 'Обновить категорию сотрудников' ), // Текст обновления таксономии во вкладке свойства. По умолчанию: __( 'Обновить метку' ) или __( 'Обновить рубрику' ).
            'add_new_item' => __( 'Добавить новую категорию сотрудников' ), // Текст добавления новой таксономии при ее создании. По умолчанию: __( 'Добавить новую метку' ) или __( 'Добавить новую рубрику' ).
            ...
            'search_items' => __( 'Поиск категорий сотрудников' ), // Текст в кнопке поиска на странице всех таксономий. По умолчанию: __( 'Поиск меток' ) или __( 'Поиск рубрик' ).
            ...
            'not_found' => __( 'Категории сотрудников не найдено.' ), // Текст в случае, если запрашиваемая таксономия не найдена. По умолчанию: __( 'Меток не найдено.' ) или __( 'Рубрик не найдено.' ).
        ),
        ...
        'rewrite' => array(
            'slug' => 'personal_tax', // Текст в ЧПУ. По умолчанию: название таксономии.
    ...
    register_taxonomy( 'personal_tax', array('personal_tax'), $args );
}
// Регистрация пользовательского типа записи:
add_action( 'init', 'register_post_personal', 0 );
function register_post_personal() {
    $args = array(
        'label'  => _x( 'Сотрудники', 'Post Type General Name', 'text_domain' ), // Название пользовательского типа записи во множественном числе. По умолчанию: значение аргумента 'name' массива 'labels'.
        'labels' => array(
            'name' => _x( 'Сотрудники', 'Post Type General Name', 'text_domain' ), // Общее название пользовательского типа записи во множественном числе. Переопределяет значение 'label'. По умолчанию: _x( 'Записи', 'Post Type General Name', 'text_domain' ) или _x( 'Страницы', 'Post Type General Name', 'text_domain' ).
            'singular_name' => _x( 'Сотрудники', 'Post Type Singular Name', 'text_domain' ), // Название пользовательского типа записи в единственном числе. По умолчанию: _x( 'Запись', 'Post Type Singular Name', 'text_domain' ) или _x( 'Страница', 'Post Type Singular Name', 'text_domain' ).
            'add_new' => __( 'Добавить сотрудника', 'text_domain' ), // Текст добавления нового объекта типа записи в разделе 'Записи'/'Страницы' в админ-панели. По умолчанию: __( 'Добавить новую', 'text_domain' ).
            'add_new_item' => __( 'Добавить сотрудника', 'text_domain' ), // Текст добавления нового объекта типа записи на странице создания. По умолчанию: __( 'Добавить запись', 'text_domain' ) или __( 'Добавить страницу', 'text_domain' ).
            'edit_item' => __( 'Редактировать сотрудника', 'text_domain' ), // Текст редактирования объекта типа записи на странице редактирования. По умолчанию: __( 'Редактировать запись', 'text_domain' ) или __( 'Редактировать страницу', 'text_domain' ).
            'new_item' => __( 'Новая сотрудника', 'text_domain' ), // Текст новой объекта типа записи. По умолчанию: __( 'Новая запись', 'text_domain' ) или __( 'Новая страница', 'text_domain' ).
            'view_item' => __( 'Просмотреть сотрудника', 'text_domain' ), // Текст просмотра типа записи в админ-баре. По умолчанию: __( 'Просмотреть запись', 'text_domain' ) или __( 'Просмотреть страницу', 'text_domain' ).
            'search_items' => __( 'Поиск сотрудника', 'text_domain' ), // Текст на кнопке поиска объектов данного типа записи. По умолчанию: __( 'Поиск записей', 'text_domain' ) или __( 'Поиск страниц', 'text_domain' ).
            'not_found' => __( 'Сотрудник не найден', 'text_domain' ), // Текст в случае отрицательного результата поиска объектов данного типа записи. По умолчанию: __( 'Записей не найдено', 'text_domain' ) или __( 'Страниц не найдено', 'text_domain' ).
            'not_found_in_trash' => __( 'Сотрудника в корзине не найдено', 'text_domain' ), // Текст в случае отрицательного результата поиска объектов данного типа записи в корзине. По умолчанию: __( 'Записей в корзине не найдено', 'text_domain' ) или __( 'Страниц в корзине не найдено', 'text_domain' ).
            ...
            'all_items' => __( 'Все сотрудники', 'text_domain' ), // Текст всех объектов типа записи в подменю. По умолчанию: __( 'Все записи', 'text_domain' ) или __( 'Все страницы', 'text_domain' ).
            'archives' => __( 'Архивы сотрудников', 'text_domain' ), // Текст архивов типа записи. По умолчанию: __( 'Архивы записей', 'text_domain' ) или __( 'Архивы страниц', 'text_domain' ).
            'insert_into_item' => __( 'Вставить в сотрудника', 'text_domain' ), // Текст добавления медиафайлов в объект типа записи во вкладке 'Добавить медиазапись'. По умолчанию: __( 'Вставить в запись', 'text_domain' ) или __( 'Вставить в страницу', 'text_domain' ).
            ...
            'menu_name' => __( 'Сотрудники', 'text_domain' ), // Текст в пункте меню. По умолчанию: значение аргумента 'name'.
            'name_admin_bar' => __( 'Сотрудники', 'text_domain' ), // Текст в админ-баре во вкладке 'Добавить'. По умолчанию: значение аргумента 'singular_name'.
            'items_list' => __( 'Список сотрудников', 'text_domain' ), // Текст Screen reader в заголовке в разделе всех записей/страниц. По умолчанию: __( 'Список записей', 'text_domain' ) или __( 'Список страниц', 'text_domain' ).
        ...
        'menu_position' => 20, /* Порядок расположения в админ-меню. Значение аргумента 'show_in_menu' должно быть true. По умолчанию: null - после пункта 'Комментарии'.
        Возможные значения:
        ...
        */
        'menu_icon' => 'dashicons-businessman', // URL для загрузки изображения в админ-меню. По умолчанию: null - используется изображение пункта меню 'Записи'. Ссылки на изображения доступны здесь: https://developer.wordpress.org/resource/dashicons/  
        ...
        */
        ...
        'taxonomies' => array('personal_tax'), // Массив связанных таксономий для данного типа записи. Пользовательскую таксономию необходимо зарегестрировать через функцию register_taxonomy(). По умолчанию: без таксономий.
        ...
        'rewrite' => array(
            'slug' => 'personal', // Текст в ссылке. По умолчанию: значение $post_type.
